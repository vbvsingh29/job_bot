  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 relative">
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 mb-6 shadow-sm">
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-5 mb-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div>
              ...
              {user?.linkedinConnected && (
                <div className="mt-2 text-xs text-gray-400 dark:text-gray-500 flex flex-col gap-0.5">
                  <p>Connected as: <span className="font-semibold text-gray-600 dark:text-gray-300">{user.linkedinName || 'LinkedIn User'}</span></p>
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-5 mb-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 opacity-70">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-400">Coming Soon</span>
              </div>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Naukri OAuth via Chrome Extension is under development.</p>
            </div>
          </div>
          <div className="w-full md:w-auto">
            <button
              type="button"
              disabled
              className="px-4 py-2.5 bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400 text-sm font-semibold rounded-lg w-full md:w-auto cursor-not-allowed"
            >
              Connect Naukri
            </button>
          </div>
